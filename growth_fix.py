...
def growth(inimg, outdata, rmin=1, rmax=50, rbin=1, xobj=0.0, yobj=0.0, salgor='median', annu=50, dannu=5, skyconst=0.0):
...
if __name__=="__main__":
    ...
    parser.add_option("--xobj", dest="xobj", type="float", default=0.0,
                      help="Object X coordinate (default=0.0)")
    parser.add_option("--yobj", dest="yobj", type="float", default=0.0,
                      help="Object Y coordinate (default=0.0)")
    ...
    ret = growth(args[0],args[1], rmin=options.rmin, rmax=options.rmax, rbin=options.rbin, xobj=options.xobj, yobj=options.yobj, salgor=options.salgor, annu=options.annu, dannu=options.dannu, skyconst=options.skyconst)
